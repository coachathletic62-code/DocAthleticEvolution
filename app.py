    ...
    <div class="druck-block">
        ...
        <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 13px;">
            ...
            <tbody>
                ...
                <tr>
                    <td style="padding: 6px; border: 1px solid #000;">Spez. Erwärmung (STL locker/frequentiert)</td>
                ...
                <tr>
                    ...
                    <td style="padding: 6px; border: 1px solid #000;">>80% ({gewichtsstange} Stange)</td>
                ...
                <tr>
                    ...
                    <td style="padding: 6px; border: 1px solid #000; text-align: center;">10s Pause</td>
                    <td style="padding: 6px; border: 1px solid #000;"></td>
                </tr>
                <tr>
