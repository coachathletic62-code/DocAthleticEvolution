...
if st.session_state.navigations_status == 'Start':
    ...
    for woche in te_liste:
        ...
        <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 14px; color: #ffffff !important;">
        <tr style="background-color: #1f2833; border-bottom: 2px solid #45a29e;">
        <th style="padding: 8px; border: 1px solid #333333; color: #66fcf1 !important;">Block / Trainingsmittel</th>
        <th style="padding: 8px; border: 1px solid #333333; color: #66fcf1 !important; text-align: center;">Sätze</th>
        <th style="padding: 8px; border: 1px solid #333333; color: #66fcf1 !important;">Strecke/Wdh.</th>
        <th style="padding: 8px; border: 1px solid #333333; color: #66fcf1 !important;">Intensität/Last</th>
        <th style="padding: 8px; border: 1px solid #333333; color: #66fcf1 !important; text-align: center;">Pause</th>
        <th style="padding: 8px; border: 1px solid #333333; color: #66fcf1 !important;">SBE(Ist)</th>
        </tr>
    ...
    st.markdown("""
        ...
        <button onclick="window.print()" style="background-color: #66fcf1; color: #000000; border: none; border-radius: 8px; padding: 15px 30px; font-weight: 900; cursor: pointer; font-size: 16px;">
        🖨️ ANSICHT DIREKT ALS PDF / DRUCKEN (WLAN)
        </button>
        </div>
    """, unsafe_allow_html=True)
